...
def user(setup_db):
    u = User(first_name='Patrick', last_name='Martin',
             address='1 rue du Chemin, 75000 Paris', phone_number='0123456789')
...
def test__check_phone_number(setup_db):
    user_good = User(first_name='John', last_name='Doe',
                     address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
    user_bad = User(first_name='John', last_name='Doe',
                    address='12 avenue Corneille, 28000 Chartres ', phone_number='abcs')
...
def test__check_names_empty(setup_db):
    user_bad = User(first_name='', last_name='',
                    address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
...
def test__check_names_invalid_characters(setup_db):
    user_bad = User(first_name='Patrickù*$:;', last_name='é-_(_',
                    address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
...
def test_not_exists():
    u = User(first_name='John', last_name='Martin',
             address='1 rue du Chemin, 75000 Paris', phone_number='0123456789')
    assert u.exists() is False


def test_delete(setup_db):
    user_test = User(first_name='John', last_name='Doe',
                     address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
    user_test.save()
...
def test_save(setup_db):
    user_test = User(first_name='John', last_name='Doe',
                     address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
    user_test_dup = User(first_name='John', last_name='Doe',
                         address='12 avenue Corneille, 28000 Chartres ', phone_number='0123456789')
